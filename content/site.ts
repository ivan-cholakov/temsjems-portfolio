    ...
    extraImages: [
      {
        ...
        width: 1500,
        height: 2000,
        alt: "Corner detail of The Fabric of Touch: black-and-white linocut printed on reclaimed woven polypropylene, stitched into a raw fabric border, mounted on a hand-lashed branch frame with jute cord binding at the corners.",
        label: "CORNER STUDY",
        note: "Hand-lashed branch frame, jute cord binding at the corners.",
      },
    ],
  },
];
