...
/**
 * Site-wide footer. Rendered once from the root layout, and outside the
 * wrapper that insets page content, so it pays the rail inset itself to line
 * up with the copy above it.
 */
export function Footer() {
  return (
    <footer className="mt-24 border-t border-ink/15 md:mt-32">
      <div className="shell py-16 md:py-20 md:pl-rail-inset">
        <div className="grid grid-cols-12 gap-x-6 gap-y-10">
          <div className="col-span-12 md:col-span-7">
            <Eyebrow as="p" size="section">Newsletter</Eyebrow>
        ...
        <div className="mt-16 flex flex-col gap-2 border-t border-ink/10 pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="eyebrow text-eyebrow">© {SITE.name}</p>
        </div>
      </div>
    </footer>
  );
